/* Version: A_01 - 08.01. 2023 - 13:26:24 */
...
document.querySelector("#adform_square").insertAdjacentElement("beforebegin", div);
    
//setTimeout(function(){
console.log("call Impressionmedia push");
Impressionmedia.events.push(function() {Impressionmedia.DisplayAcceptableAdIfAdblocked({"zoneid": 1403239,"containerid": "crt-1403239-in-pocasicz","overrideZoneFloor": false,"callbacksuccess": function(){console.log("antiAdBlock callbacksuccess");
...
var div = document.createElement("div");
div.setAttribute("id", "crt-1406723-in-pocasicz");
...
//setTimeout(function(){
console.log("call Impressionmedia push");
Impressionmedia.events.push(function() {Impressionmedia.DisplayAcceptableAdIfAdblocked({"zoneid": 1406723,"containerid": "crt-1406723-in-pocasicz","overrideZoneFloor": false,"callbacksuccess": function(){console.log("antiAdBlock callbacksuccess");
